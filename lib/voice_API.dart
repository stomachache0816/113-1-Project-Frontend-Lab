...
Future<String> uploadAudioFile(String filePath) async {
  var url = 'http://192.168.1.112:5000/app_voice';
  // var url = 'http://dynamic-ip.osrbr.com:5000/app_voice';
...
Future<Map<dynamic, dynamic>> getAnalysis() async {
  var url = 'http://192.168.1.112:5000/get_analysis';
  // var url = 'http://dynamic-ip.osrbr.com:5000/get_analysis';
  var uri = Uri.parse(url);
...
Future<List<dynamic>> getHistory() async {
  var url = 'http://192.168.1.112:5000/get_history';
  // var url = 'http://dynamic-ip.osrbr.com:5000/get_history';
  var uri = Uri.parse(url);
  final response = await http.get(uri);
